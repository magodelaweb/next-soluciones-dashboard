  ...
  <div class="mai-wrapper mai-login">
    <div class="main-content container">
      <div class="splash-container row">
        <div class="col-md-6 user-message"><span class="splash-message text-right">¡Hola!<br> es bueno<br> verte de nuevo</span><span class="alternative-message text-right">¿No tienes una cuenta? <a href="{{route("register")}}">Regístrate</a></span></div>
